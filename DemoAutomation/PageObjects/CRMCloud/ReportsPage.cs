...
namespace DemoAutomation.PageObjects.CommonPages
{
    public class ReportsPage
    {
        ...
        #region Locators
        PageElement Results_label(string report) => new PageElement(_Driver, By.XPath($"//div[contains(@class,'input-label') and text()='{report}']"));
        ...
        {
            new PageElement(_Driver, By.Id("filter_text")).SendKeys(report);
            Results_label(report).Click();
